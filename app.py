...
if prompt := st.chat_input("Nhập câu hỏi hoặc nội dung cần kiểm tra luật..."):
    ...
    with st.chat_message("assistant"):
        ...
        message_placeholder.markdown("🔍 Hệ thống đang phân tích...")
        ...
        try:
            ...
            if response.status_code == 403:
                ...
                response = requests.post(API_URL, json=payload, headers=fallback_headers, timeout=30)
            ...
            st.error("⏱️ Yêu cầu quá thời gian chờ (timeout). Vui lòng thử lại.")
            message_placeholder.markdown("⚠️ Kết nối với API mất quá nhiều thời gian.")
